...
std::string document_writer::render_pseudoknots(rna_tree &rna) const
{
    ostringstream out;

    auto pn_segments = find_pseudoknot_segments(rna.begin_pre_post(), rna.end_pre_post());
